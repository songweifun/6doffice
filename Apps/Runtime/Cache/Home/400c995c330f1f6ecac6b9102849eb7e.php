                ...
                <LI class=li_bottom>
                    <DIV class="div_border home_bg_all">
                        ...
                        <DIV class="link_deep_blue f_l text_r">
                            <STRONG>
                                <A class=f14 href="<?php echo U('Company/Login/index');?>" rel=nofollow>公司管理</A>
                            </STRONG><BR>
                            经纪公司网络管理平台
                            <P class=p_link_box>
                                <A class=p_link_a  href="<?php echo U('Company/Login/index');?>" rel=nofollow>进入公司管理通道<I class="front_global_icon more_icon">&nbsp;</I></A>
                            </P>
                        </DIV>
                    </DIV>
                </LI>
