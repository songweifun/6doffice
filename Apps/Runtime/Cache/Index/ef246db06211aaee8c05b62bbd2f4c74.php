        ...
        <div class="banner_magnr">
            ...
            <div class="row liebiaoye">
                <div class="col-sm-12">
                        <ul class="nav nav-pills">
                            <li role="presentation" class="active"><a href="#">查房价</a></li>
                            <li role="presentation"><a href="#" style="color: white">买新房</a></li>
                            <li role="presentation"><a href="#" style="color: white">买二手房</a></li>
                            <li role="presentation"><a href="#" style="color: white">找租房</a></li>
                            <li role="presentation"><a href="#" style="color: white">装修家居</a></li>
