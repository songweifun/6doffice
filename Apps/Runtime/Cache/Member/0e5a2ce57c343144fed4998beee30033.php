...
<head>
    ...
    <title><?php echo ($title); ?> - 身份认证</title>
...
<div class="main">
    ...
    <div class="endLeft"></div>
        ...
        <div class="memberBox">
            ...
            <?php if($memberInfo['idcard'] == null): if($memberInfo['mobile'] == null): ?><div class="bigNote" id="bigNote">
            ...
            <form name="dataInfo" method="POST" action="?action=save">
                <table class="memberBoxTable" cellpadding="0" cellspacing="5" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <?php if($memberInfo['realname'] != null): ?><font color="#FF0000"><?php echo ($memberInfo["realname"]); ?></font>
                            <?php else: ?>
                            <b>请在从业资料中填写真实姓名</b><?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="row2">&nbsp;
                            ...
                            <iframe name="uploadIdcardPicture" width="100%" height="35" scrolling="No" frameborder="no"  src="<?php echo U(MODULE_NAME.'/ManageBroker/webuploader');?>/to/uploadIdcardPicture|broker|identity" align="left"></iframe>
                        </td>
                        <td colspan="2">
                            <span class="tip">合格身份证图片示例</span><br />
                            <input type="hidden" id="idcard_pic" name="idcard_pic" valid="required" errmsg="请上传身份证图片!" >
                            <div id="idcard_pic_dis"><img class="demoImgBorder" src="/6doffice/Public/images/demoIdentity.jpg" width="220" height="130" title="身份证例图" /></div>
                        </td>
                    </tr>
                    <tr><td colspan="4" class="br"></td></tr>
                    </tbody>
                </table>
                <?php if($memberInfo['realname'] != null): ?><div class="submitBtn"><input type="button" value="提交审核" onclick="javascript:if(validator(document.dataInfo)){document.dataInfo.submit();}"  /></div>
                <?php else: ?>
                <font color="#FF0000" size="+2">请先完善从业资料在进行身份证审核!</font><?php endif; ?>
            </form>
            <?php else: ?>
            <div class="sysConfirm" id="sysConfirm">
                <div class="confirmTxt">恭喜^_^，您已通过 <?php echo ($title); ?>实名认证！
                    <p>在您的个人信息展示位置体现<img src="/6doffice/Public/images/brokerIdentity.png" title=" <?php echo ($title); ?>实名认证标志" />认证标志，同时您已拥有了 <?php echo ($title); ?>经纪人网店。<a href="<?php echo U(MODULE_NAME.'/ManageShop/shopSaleRec');?>" class="underline" title="进入店铺管理">马上去张罗您的店铺，开张吧！</a></p>
                </div>
            </div><?php endif; ?>
        </div>
    </div>
...
<script language="javascript">
    function uploadIdcardPicture( furl,fname,thumbUrl ){
        ...
        document.getElementById('idcard_pic_dis').innerHTML = '<a href="/6doffice/Uploads/'+furl+'"><img src="/6doffice/Uploads/'+furl+'" width="220" height="130" title="身份证"></a>';
    }
</script>
</body>
</html>