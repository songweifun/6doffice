                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <select class="select" name="house_room">
                                <?php $__FOR_START_1044497817__=1;$__FOR_END_1044497817__=5;for($i=$__FOR_START_1044497817__;$i < $__FOR_END_1044497817__;$i+=1){ if($i == $dataInfo["house_room"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                            ...
                            <select class="select" name="house_hall">
                                <?php $__FOR_START_1728853077__=1;$__FOR_END_1728853077__=6;for($i=$__FOR_START_1728853077__;$i < $__FOR_END_1728853077__;$i+=1){ if($i == $dataInfo["house_hall"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
                        </select> 厅
                            <select class="select" name="house_toilet">
                                <?php $__FOR_START_1753393149__=1;$__FOR_END_1753393149__=6;for($i=$__FOR_START_1753393149__;$i < $__FOR_END_1753393149__;$i+=1){ if($i == $dataInfo["house_toilet"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
                        </select> 卫
                            <select class="select" name="house_veranda">
                                <?php $__FOR_START_679350514__=1;$__FOR_END_679350514__=6;for($i=$__FOR_START_679350514__;$i < $__FOR_END_679350514__;$i+=1){ if($i == $dataInfo["house_veranda"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
