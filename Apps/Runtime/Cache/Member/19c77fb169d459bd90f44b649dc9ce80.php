                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <select class="select" name="house_room">
                                <?php $__FOR_START_501277821__=1;$__FOR_END_501277821__=5;for($i=$__FOR_START_501277821__;$i < $__FOR_END_501277821__;$i+=1){ if($i == $dataInfo["house_room"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                        <?php else: ?>
                            ...
                            <select class="select" name="house_hall">
                                <?php $__FOR_START_220814626__=1;$__FOR_END_220814626__=6;for($i=$__FOR_START_220814626__;$i < $__FOR_END_220814626__;$i+=1){ if($i == $dataInfo["house_hall"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                        <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
                            </select> 厅
                            <select class="select" name="house_toilet">
                                <?php $__FOR_START_966568298__=1;$__FOR_END_966568298__=6;for($i=$__FOR_START_966568298__;$i < $__FOR_END_966568298__;$i+=1){ if($i == $dataInfo["house_toilet"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                        <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
                            </select> 卫
                            <select class="select" name="house_veranda">
                                <?php $__FOR_START_436447830__=1;$__FOR_END_436447830__=6;for($i=$__FOR_START_436447830__;$i < $__FOR_END_436447830__;$i+=1){ if($i == $dataInfo["house_veranda"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                        <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
