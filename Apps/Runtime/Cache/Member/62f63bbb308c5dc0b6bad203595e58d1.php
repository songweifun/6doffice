...
<head>
    ...
    <title><?php echo ($title); ?> - 查看收件箱</title>
        ...
        <div class="memberBox">
            <div class="msgOperationBox">
                <ul class="msgOperation">
                    ...
                    <li class="linkOn"><a href="<?php echo U(MODULE_NAME.'/ManageMessage/msgInbox');?>"><span>收件箱(<?php echo ($msgCount); ?>)</span></a></li>
                    ...
                    <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <form name="myform" action="" method="POST">
                            ...
                            <?php if(is_array($dataList)): foreach($dataList as $key=>$item): ?><tr>
                                ...
                                <td class="msgTitleLeft"><?php if($item["is_new"] != 0): ?><img src="/6doffice/Public/images/msgUnread.gif" title="未读" /><?php else: ?><img src="/6doffice/Public/images/msgRead.gif" title="已读" /><?php endif; ?>&nbsp;<a href="<?php echo U(MODULE_NAME.'/ManageMessage/msgDetail');?>/id/<?php echo ($item["id"]); ?>" title="打开信件"><?php echo ($item["msg_title"]); ?></a></td>
                                <td><?php echo ($item["msg_from"]); ?></td>
                            ...
                            <tr>
                                <td colspan="4" class="listOperation">
                                    ...
                                    <input class="listOperationBtn" type="button" value="删除选中的信件" onclick="if(confirm('你确认要删除选中的信件么？')){myform.action='?action=toDel';myform.submit();}" />
                                </td>
                            </tr>
                            </tbody>
                        </form>
