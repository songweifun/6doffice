    ...
    <script>
        ...
        $('#topForm').validate(
            ...
            $('#submitBtn').click(function(){
                var ajaxSaveRentTopUrl='<?php echo U(MODULE_NAME."/ManageRent/ajaxSaveRentTop");?>';
                var tourlRentTopDone='<?php echo U(MODULE_NAME."/ManageRent/RentTopDone");?>'
                var days=$('#days').val();
                ...
                /*if(confirm('确认将会从您的账户中扣除相应的费用，确认么？')){
                    dataForm.action='<?php echo U(MODULE_NAME."/ManageRent/ajaxSaveRentTop");?>/action/save';
                    dataForm.submit();}*/
...
<div id="modalWindow">
    ...
    <p>
        每天置顶房源的价格为<?php echo ($rentPrice); ?>元
    </p>
    <p>
        置顶金额 = <?php echo ($rentPrice); ?> * 置顶天数
    </p>
