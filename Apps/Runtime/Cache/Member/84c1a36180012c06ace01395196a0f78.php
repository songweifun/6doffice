                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <select class="select" name="house_room">
                                <?php $__FOR_START_1823564808__=1;$__FOR_END_1823564808__=5;for($i=$__FOR_START_1823564808__;$i < $__FOR_END_1823564808__;$i+=1){ if($i == $dataInfo["house_room"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                            ...
                            <select class="select" name="house_hall">
                                <?php $__FOR_START_1689893253__=1;$__FOR_END_1689893253__=6;for($i=$__FOR_START_1689893253__;$i < $__FOR_END_1689893253__;$i+=1){ if($i == $dataInfo["house_hall"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
                        </select> 厅
                            <select class="select" name="house_toilet">
                                <?php $__FOR_START_324007156__=1;$__FOR_END_324007156__=6;for($i=$__FOR_START_324007156__;$i < $__FOR_END_324007156__;$i+=1){ if($i == $dataInfo["house_toilet"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
                        </select> 卫
                            <select class="select" name="house_veranda">
                                <?php $__FOR_START_455254103__=1;$__FOR_END_455254103__=6;for($i=$__FOR_START_455254103__;$i < $__FOR_END_455254103__;$i+=1){ if($i == $dataInfo["house_veranda"]): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php endif; } ?>
