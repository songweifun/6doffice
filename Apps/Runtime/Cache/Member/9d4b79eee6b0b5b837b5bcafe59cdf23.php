            ...
            <div class="manageBox">
                <div class="houseSearch">
                    <form name="searchForm" action="" method="GET">
                        ...
                        <input class="input" name="q" type="text" size="36" value="<?php if($q != null): echo ($q); else: ?>输入小区名，或买/卖方信息，或备注信息<?php endif; ?>" onblur="if(this.value ==''||this.value == '输入小区名，或买/卖方信息，或备注信息'){this.value = '输入小区名，或买/卖方信息，或备注信息';}" onfocus="if(this.value == '输入小区名，或买/卖方信息，或备注信息'){this.value = '';}" />
                ...
                <div class="houseList">
                    <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <?php if(is_array($dataList)): foreach($dataList as $key=>$item): ?><tr>
                            ...
                            <td class="f90"><?php echo ($item["bargain_price"]); ?>万</td>
...
<script language="javascript">
    function showBox(item_id){
        var url='<?php echo U(MODULE_NAME."/ManageSell/sellBargain");?>/id/'+item_id
        layer.open({
            type: 2,
            title: ['房源成交', ''],
            maxmin: true,
    ...
    function showRemark(item_id){
        var url='<?php echo U(MODULE_NAME."/ManageSell/remark");?>/id/'+item_id
