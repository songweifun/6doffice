...
<div id="modalWindow">
    <form name="dataForm" method="POST" action="">
        ...
        <p>
            <label>房源租金:</label>
            <input type="text" id="house_price" name="house_price" class="input" size="10" value="<?php echo ($dataInfo["house_price"]); ?>" />元/月
        </p>
        <p>
            <label>交易来源:</label>
...
<script language="javascript">
    var ajaxSaveBargainUrl="<?php echo U(MODULE_NAME.'/ManageRent/ajaxSaveBargain');?>";
