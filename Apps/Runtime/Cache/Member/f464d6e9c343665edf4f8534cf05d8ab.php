                ...
                <div class="houseList">
                    <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <?php if(is_array($dataList)): foreach($dataList as $key=>$item): ?><tr>
                            ...
                            <td><a href="<?php echo U(MODULE_NAME.'/HouseSell/addsell');?>/action/edit/id/<?php echo ($item["id"]); ?>" title="编辑房源信息">编辑</a>&nbsp;<a href="?house_id=<?php echo ($item["id"]); ?>" onclick="showBox(<?php echo ($item["id"]); ?>);return false;" title="该房源已成交">成交</a>&nbsp;<a href="<?php echo U(MODULE_NAME.'/ManageSell/sellTopDone');?>/action/noTop/id/<?php echo ($item["id"]); ?>" onclick="javascript:return noTop();">取消</a></td>
