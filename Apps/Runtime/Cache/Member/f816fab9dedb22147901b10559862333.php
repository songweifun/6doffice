        ...
        <div class="memberBox">
            ...
            <div class="manageSub">
                <ul class="manageSubNav">
                    <li><a href="<?php echo U(MODULE_NAME.'/HouseRent/index');?>"><span>出售中</span></a></li>
                    ...
                    <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <form name="myform" action="" method="POST">
                            ...
                            <?php if(is_array($dataList)): foreach($dataList as $key=>$item): ?><tr>
                                ...
                                <td><?php if($item["status"] == 2): ?><a href="<?php echo U(MODULE_NAME.'/ManageRent/added');?>/id/<?php echo ($item["id"]); ?>" title="重新上架房源">上架</a><?php else: ?>已过期<?php endif; ?></td>
...
<script language="javascript">
    $('#listOperationBtn').click(function(){
        if(confirm('你确定彻底删除选中的房源么？')){
            myform.action='<?php echo U(MODULE_NAME."/ManageRent/delete");?>';
