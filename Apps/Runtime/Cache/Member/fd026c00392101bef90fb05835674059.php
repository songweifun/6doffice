...
<script language="javascript">
    ...
    var ajaxSaveBargainRemarkUrl="<?php echo U(MODULE_NAME.'/ManageSell/ajaxSaveBargainRemark');?>";
    ...
    function addBorough(){
        ...
        /*$.post('ajax.php?action=saveBargainRemark&request=ajax',{id:thisid,remark:remark},function(data){
            //返回ID
            //alert(data);
            if(data ==0){
                alert('提交错误');
