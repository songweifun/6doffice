...
<div class="main">
    ...
    <div class="endLeft"></div>
        ...
        <div class="memberBox">
            ...
            <?php if($memberInfo['mobile'] == null): ?><div class="sysNote">
            ...
            <div class="manageSub">
                <ul class="manageSubNav">
                    <li class="linkOn"><a href="<?php echo U(MODULE_NAME.'/ManageShop/shopSaleRec');?>"><span>出售中</span></a></li>
                    <li><a href="<?php echo U(MODULE_NAME.'/ManageShop/shopRentRec');?>"><span>出租中</span></a></li>
                </ul>
            </div>
            <div class="manageBox">
                <div class="houseSearch">
                    <form name="searchForm" action="" method="GET">
                        ...
                        <option value="2"  <?php if(($_GET['is_promote']!= null) AND ($_GET['is_promote']== 0)): ?>selected<?php endif; ?>>未推荐</option>
                    </select>&nbsp;
                    ...
                    <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <form name="myform" enctype="text/html" action="" method="POST">
                            ...
                            <?php if(is_array($dataList)): foreach($dataList as $key=>$item): if($item['is_promote'] == 2): ?><tr>
                                ...
                                <td class="f90"><?php echo ($item["house_price"]); ?>万</td>
                                <td><?php echo ($item["day_left"]); ?>天</td>
                                <td>未推荐</td>
                                <td><a href="<?php echo U(MODULE_NAME.'/ManageShop/shopSaleRec');?>/action/promote/id/<?php echo ($item["id"]); ?>" title="推荐到橱窗">推荐</a></td>
                            </tr>
                            <?php else: ?>
                            <tr>
                                <td><input type="checkbox" name="ids[]" value="<?php echo ($item["id"]); ?>" />&nbsp;<a href="<?php echo ($cfg["url_sale"]); ?>d-<?php echo ($item["id"]); ?>.html" title="查看房源详细信息" target="_blank"><?php echo ($item["house_no"]); ?></a></td>
                                ...
                                <td><?php echo ($item["day_left"]); ?>天</td>
                                <td class="f90">已推荐</td>
                                    <td><a href="<?php echo U(MODULE_NAME.'/ManageShop/shopSaleRec');?>/action/cancel/id/<?php echo ($item["id"]); ?>" title="取消橱窗推荐">取消</a></td>
